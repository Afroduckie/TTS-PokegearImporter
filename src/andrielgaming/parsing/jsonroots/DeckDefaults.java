...
public class DeckDefaults
{
	...
	public String XmlUI = "";			
	public ObjectStates[] ObjectStates = { new ObjectStates((""+UUID.randomUUID()).substring(0,6), "", new DeckTransform(0, 0, 0, 0, 180, 180, 1.15f, 1.1f, 1.1f), "", "", new DeckColorDiffuse(0.7f, 0.7f, 0.7f), "", 0, 0, false, true, true, false, false, true, true, true, true, false, true, false, false, new ArrayList<Integer>(), new TreeMap<String, LinkedTreeMap<String, Object>>(), "", "", "") };
